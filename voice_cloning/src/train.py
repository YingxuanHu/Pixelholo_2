...
def _patch_config(
    ...
    if not isinstance(loss_params, dict):
        loss_params = {}
    loss_params["lambda_mono"] = 5.0
    loss_params["lambda_s2s"] = 2.0
...
def main() -> None:
    ...
    parser.add_argument("--tune_ref_count", type=int, default=3, help="Number of references for tuning")
    parser.add_argument(
        "--tune_text",
        type=str,
    ...
    parser.add_argument("--select_ref_count", type=int, default=3, help="Number of references for selection")
    parser.add_argument(
        "--select_text",
        type=str,
        default="Hello, this is a quick pitch calibration sample.",
